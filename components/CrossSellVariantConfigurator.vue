...
const productDetailsResponse = ref({});
  ...
  productDetailsResponse.value = response.data;
  console.warn('productDetailsResponse->>>>>', productDetailsResponse)
...
} = useProductCrossSellConfigurator(
