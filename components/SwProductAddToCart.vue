...
import ProductCustomizedProductConfigurator from "./ProductCustomizedProductConfigurator.vue";
...
const {
  addToCart: addCustomizedProductToCart,
...
const addToCartProxy = async () => {
  if (!isCustomizedProductActive.value) {
    ...
    await addCustomizedProductToCart();
  }
